...
public class TicTacToe : MonoBehaviour
{
    ...
    public Difficulty CurrentDifficulty { get => _difficulty; }

    public void OnScreenClick(InputAction.CallbackContext context)
	{
		Debug.Log("OnScreenClick is called");
		
		if(GameManager.Instance.CurrentState != GameState.GameRunning || context.canceled)
		{
			return;
		}
	...
	public void Initialize(Difficulty difficulty)
	{
		...
		Debug.Log("Initializing Game: " + difficulty.ToString());
	...
	private void Update() 
	{
		...
		if(GameManager.Instance.CurrentState != GameState.GameRunning)
		{
			return;
		}
		if(_winner != PlayerType.None || CountVacants() == 0)
